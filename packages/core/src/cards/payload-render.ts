 ...
 *
 * Note: `valueLabel` is the canonical value-enum → Bahasa helper. It lives in
 * `./event-render` (the CD-T1 canonical location); this module re-exports it so
 * callers can import from one place.
 */

import { valueLabel as _valueLabel } from "./event-render";

// Re-export so callers can import valueLabel from payload-render or event-render.
export { valueLabel } from "./event-render";
